...
EXCEL_INPUT_PATH = "tests/excel/input_1000.xlsx"
...
input_dataset_cfg_1 = Config.configure_excel_data_node(id="input_dataset_1", path=EXCEL_INPUT_PATH, has_header=True)
output_dataset_cfg_1 = Config.configure_excel_data_node(id="output_dataset_1", path=EXCEL_OUTPUT_PATH, has_header=True)
...
input_dataset_cfg_2 = Config.configure_excel_data_node(
    id="input_dataset_2", path=EXCEL_INPUT_PATH, has_header=True, exposed_type=Row)
output_dataset_cfg_2 = Config.configure_excel_data_node(
    id="output_dataset_2", path=EXCEL_OUTPUT_PATH, has_header=True, exposed_type=Row)
...
input_dataset_cfg_3 = Config.configure_excel_data_node(
    id="input_dataset_3", path=EXCEL_INPUT_PATH, has_header=True, exposed_type="numpy")
output_dataset_cfg_3 = Config.configure_excel_data_node(
    id="output_dataset_3", path=EXCEL_OUTPUT_PATH, has_header=True, exposed_type="numpy")
...
input_dataset_cfg_4 = Config.configure_excel_data_node(
    id="input_dataset_4", path=EXCEL_INPUT_PATH, has_header=True, exposed_type="modin")
output_dataset_cfg_4 = Config.configure_excel_data_node(
    id="output_dataset_4", path=EXCEL_OUTPUT_PATH, has_header=True, exposed_type="modin")
