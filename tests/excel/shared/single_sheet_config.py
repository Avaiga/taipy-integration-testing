...
EXCEL_SINGLE_SHEET_INPUT_PATH = "tests/excel/input_1000.xlsx"
EXCEL_SINGLE_SHEET_OUTPUT_PATH = "tests/excel/output_1000.xlsx"
ROW_COUNT = 1000
SHEET_NAME = "Sheet1"
...
input_dataset_cfg_1 = Config.configure_excel_data_node(id="input_dataset_1", path=EXCEL_SINGLE_SHEET_INPUT_PATH, has_header=True, sheet_name=SHEET_NAME)
output_dataset_cfg_1 = Config.configure_excel_data_node(id="output_dataset_1", path=EXCEL_SINGLE_SHEET_OUTPUT_PATH, has_header=True, sheet_name=SHEET_NAME)
...
input_dataset_cfg_2 = Config.configure_excel_data_node(
    id="input_dataset_2", path=EXCEL_SINGLE_SHEET_INPUT_PATH, has_header=True, exposed_type=Row, sheet_name=SHEET_NAME)
output_dataset_cfg_2 = Config.configure_excel_data_node(
    id="output_dataset_2", path=EXCEL_SINGLE_SHEET_OUTPUT_PATH, has_header=True, exposed_type=Row, sheet_name=SHEET_NAME)
...
input_dataset_cfg_3 = Config.configure_excel_data_node(
    id="input_dataset_3", path=EXCEL_SINGLE_SHEET_INPUT_PATH, has_header=True, exposed_type="numpy", sheet_name=SHEET_NAME)
output_dataset_cfg_3 = Config.configure_excel_data_node(
    id="output_dataset_3", path=EXCEL_SINGLE_SHEET_OUTPUT_PATH, has_header=True, exposed_type="numpy", sheet_name=SHEET_NAME)
...
input_dataset_cfg_4 = Config.configure_excel_data_node(
    id="input_dataset_4", path=EXCEL_SINGLE_SHEET_INPUT_PATH, has_header=True, exposed_type="modin", sheet_name=SHEET_NAME)
output_dataset_cfg_4 = Config.configure_excel_data_node(
    id="output_dataset_4", path=EXCEL_SINGLE_SHEET_OUTPUT_PATH, has_header=True, exposed_type="modin", sheet_name=SHEET_NAME)
