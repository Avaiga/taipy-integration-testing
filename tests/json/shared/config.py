...
input_dataset_cfg_1 = Config.configure_json_data_node(id="input_dataset_1", path=JSON_DICT_INPUT_PATH)
output_dataset_cfg_1 = Config.configure_json_data_node(
    id="output_dataset_1", path=JSON_DICT_OUTPUT_PATH)
...
input_dataset_cfg_2 = Config.configure_json_data_node(
    id="input_dataset_2", path=JSON_OBJECT_INPUT_PATH, decoder=RowDecoder)
output_dataset_cfg_2 = Config.configure_json_data_node(
    id="output_dataset_2", path=JSON_OBJECT_OUTPUT_PATH, encoder=RowEncoder, decoder=RowDecoder)
