# Copyright 2025 Avaiga Private Limited
#
...
class TestTaipyRunCommand:
    ...
    def test_run_simple_taipy_app_with_taipy_args(self, capfd):
    ...
    def test_run_simple_taipy_app_with_taipy_and_external_args(self, capfd):
        with pytest.raises(SystemExit):
            with patch(
                "sys.argv",
                [
