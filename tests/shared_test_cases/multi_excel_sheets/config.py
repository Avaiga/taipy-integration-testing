...
input_dataset_cfg_1 = Config.configure_excel_data_node(
    id="input_excel_multi_sheet_dataset_1", path=EXCEL_INPUT_PATH, has_header=True, sheet_name=SHEET_NAMES
)
output_dataset_cfg_1 = Config.configure_excel_data_node(
    id="output_excel_multi_sheet_dataset_1", path=EXCEL_OUTPUT_PATH, has_header=True, sheet_name=SHEET_NAMES
)
...
input_dataset_cfg_2 = Config.configure_excel_data_node(
    id="input_excel_multi_sheet_dataset_2",
...
output_dataset_cfg_2 = Config.configure_excel_data_node(
    id="output_excel_multi_sheet_dataset_2",
...
input_dataset_cfg_3 = Config.configure_excel_data_node(
    id="input_excel_multi_sheet_dataset_3",
    path=EXCEL_INPUT_PATH,
    has_header=True,
    exposed_type="numpy",
    sheet_name=SHEET_NAMES,
...
output_dataset_cfg_3 = Config.configure_excel_data_node(
    id="output_excel_multi_sheet_dataset_3",
    path=EXCEL_OUTPUT_PATH,
    has_header=True,
    exposed_type="numpy",
    sheet_name=SHEET_NAMES,
...
input_dataset_cfg_4 = Config.configure_excel_data_node(
    id="input_excel_multi_sheet_dataset_4",
    path=EXCEL_INPUT_PATH,
    has_header=True,
    exposed_type="modin",
    sheet_name=SHEET_NAMES,
...
output_dataset_cfg_4 = Config.configure_excel_data_node(
    id="output_excel_multi_sheet_dataset_4",
    path=EXCEL_OUTPUT_PATH,
    has_header=True,
    exposed_type="modin",
    sheet_name=SHEET_NAMES,
